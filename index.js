...
/*  (oto test yok) sayilar dizisi içinde kaç adet sayı olduğunu konsola yazdırın */ console.log(sayilar.length);
...
for (let sayi in tekrarSayilari) {
  if (tekrarSayilari[sayi] > 1) {
    const string = `${sayi} sayısı ${tekrarSayilari[sayi]} kere tekrar edilmiştir`;
